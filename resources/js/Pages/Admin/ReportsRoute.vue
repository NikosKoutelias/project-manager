...
<template>
    <div class="relative h-screen w-full flex items-center justify-center bg-cover bg-center text-center rounded-2xl opacity-90 drop-shadow-2xl px-5"
        ...
        <div class="absolute top-0 right-0 bottom-0 left-0 bg-gray-900 opacity-75  drop-shadow-2xl rounded-2xl"></div>
