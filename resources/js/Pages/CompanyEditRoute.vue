...
<template>
    <form @submit.prevent="submitForm">
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols- gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input v-model="data.name" type="text" name="name" id="name" class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base  text-gray-900
                    ...
                    <div class="sm:col-span-3">
                        <label for="role" class="block text-sm/6 font-medium text-gray-900">Countries</label>
                    ...
                    <div class="sm:col-span-3">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <textarea type="text" rows="5" name="description" id="description" v-model="data.description"
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button type="reset" v-on:click="deleteCompany"
