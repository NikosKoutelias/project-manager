        ...
        <header class="absolute inset-x-0 top-0 z-50">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                    <router-link :to="{name: 'Home'}" class="-m-1.5 p-1.5 scale-200">
                        <span class="sr-only">Your Company</span>
                        <img class="h-8 w-auto"
                             src="https://cdn-icons-png.flaticon.com/512/11494/11494825.png" alt="">
                    </router-link>
                </div>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Manage your Data and Projects  </h1>
                    <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">A system that supports managing of your data, companies, projects and human resources efficient.</p>
                </div>
                <div class="hidden sm:mb-8 sm:flex sm:justify-center mt-8">
                    <div
                        class="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                        Announcing our next top release of products. <a href="#" class="font-semibold text-indigo-600"><span
