...
<template>
    <div class="my-5"></div>
    <div class="flex min-h-4/5 flex-col rounded-lg justify-center px-6 py-12 lg:px-8 w-xl mx-auto border-2 border-gray-100 hover:border-gray-200 shadow-xl hover:shadow-2xl transition duration-300 max-h-10">
